...
class UI(Tk):
    ...
    def setLayout(self):
        ...
        self.reBtn = Button(self.TopLayout, text="Reset", font="Constantia 12", command=lambda: self.app.reset())
        self.pathBtn = Button(self.TopLayout, text="...", font="Constantia 12", command= lambda: self.app.choosePath())
        self.clshtr = Button(self.TopLayout, text='Clear', font="Constantia 12", command=lambda: self.app.loger.clear())
        ...
        self.reBtn.place(relx=0.3, y=80)
